...
<div id="demo">
        <div v-if="portugues" class="body__profile__button-area" id="pt-br">
          <transition name="fade" v-on:enter="enter">
                ...
                <Social />
          <button class="body__profile__button github botao"><a href="https://www.github.com/waello">View portfolio on GitHub</a></button>
...
export default {
    ...
    data() {
      return {
        trans: Boolean(true),
        portugues: Boolean,
        resume: "https://www.linkedin.com/in/wael-jlassi-281b76153/",
        curriculo: "https://www.linkedin.com/in/wael-jlassi-281b76153/",
        ptFLag: "(PT-BR)",
        enFlag: "(EN)",
        show: false,
      }
